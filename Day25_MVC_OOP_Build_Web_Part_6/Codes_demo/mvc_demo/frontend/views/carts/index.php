                    ...
                    <div class="timeline-items">
                        <form action="" method="post">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>
                                        <img class="product-avatar img-responsive" src="../backend/assets/uploads/products-1564468873product2.jpg" width="80">
                                    ...
                                    <td>
                                        <a class="content-product-a" href="xoa-san-pham/2">Xóa</a>
                                    </td>
                                </tr>
                                <tr>
            ...
            <div class="content-sidebar">
                <div class="sidebar_inner" style="position: absolute; top: 0px;">
                        ...
                        <div class="w-boxed-post">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="box-wrapper">
                                        <div class="box-left">
                                            <img src="../backend/assets/uploads/news-1565674623-product1.jpg" width="80">
                                            <!--                                    <span>--><!--</span>-->
                                        </div>
                                        <div class="box-right">
                                            <h3 class="p-title">
                    ...
                    <div class="widget-item">
                        ...
                        <div class="w-carousel-post">
                            <div class="owl-carousel" id="widgetCarousel">
                                <div class="item">
                                    <a href="#">
                                        <div class="w-play-img">
                                            <img src="http://tevratgundogdu.com/works/ideabox-html-template/img/news-test-images/news-img4.jpg" width="300">
                                ...
                                <div class="item">
                                    <a href="#">
                                        <img src="http://tevratgundogdu.com/works/ideabox-html-template/img/news-test-images/news-img5.jpg" width="300">
                                        <span class="w-post-title">Lorem Ipsum used since</span>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <img src="http://tevratgundogdu.com/works/ideabox-html-template/img/news-test-images/news-img6.jpg" width="300">
                                        <span class="w-post-title">English versions from the 1914 translation</span>
                                    </a>
                                </div>
                                <div class="item">
                                    <a href="#">
                                        <img src="http://tevratgundogdu.com/works/ideabox-html-template/img/news-test-images/news-img7.jpg" width="300">
                    ...
                    <a href="#" class="widget-ad-box">
                        <img src="http://tevratgundogdu.com/works/ideabox-html-template/img/adbox300x250.png" width="300" height="250">
                    </a>
