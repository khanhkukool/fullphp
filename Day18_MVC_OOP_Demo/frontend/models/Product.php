...
class Product extends Model
{
    ...
    public function insert($arr_params = [])
    {
        ...
        $obj_insert = $this
            ->connection
            ->prepare("INSERT INTO
products(category_id, title, avatar, price, detail, status)
VALUES(:category_id, :title, :avatar, :price, :detail, :status)
");
...
//        die;
    ...
    public function getProductCartById($id)
    {
        ...
        $obj_select = $this
            ->connection
            ->prepare("SELECT id, title, avatar, price, detail FROM products
WHERE id = :id
");
